import{q as O,d as N,e as q,g as H,h as B}from"./client.h1ccJhLt.js";const v=async()=>{const c=document.getElementById("rules-overview-timeline-container");if(!(c instanceof HTMLElement))return;const _={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},p=(r="")=>String(r).replace(/[&<>"']/g,i=>_[i]??i),w=()=>{const r=new Date,i=r.getFullYear(),e=String(r.getMonth()+1).padStart(2,"0"),l=String(r.getDate()).padStart(2,"0");return`${i}-${e}-${l}`};try{const r=O(N(q,"timeline"),H("dateStr","asc")),i=await B(r),e=[];if(i.forEach(t=>{const s=t.data();e.push({id:t.id,dateStr:s.dateStr??"",title:s.title??"未命名日程",desc:s.desc??""})}),e.length===0){c.innerHTML=`
        ...
        `}),c.innerHTML=y}catch(r){console.error("Error loading rules overview timeline:",r),c.innerHTML=`
