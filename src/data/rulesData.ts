...
export const rulesList: RuleItem[] = [
  ...
  {
    text: "參賽作品在創作過程中使用人工智慧(Artificial Intelligence，以下簡稱 AI)或生成式人工智慧(生成式 AI)作為輔助工具，而非用於產生最終設計成果，參賽者必須在初賽文件或決賽簡報中揭露使用過程或步驟並進行標注與說明。參考範例：本報告撰寫過程中曾使用人工智慧工具輔助資料整理與文字潤飾，所有內容已由作者進行審閱與修訂，並對最終內容負責。若經查核發現使用 AI 但未在初賽文件或決賽簡報中標明，主辦單位有權重新評分或不予計分。此外，若經檢舉、告發或查證屬實，將取消其參賽資格及得獎資格，並追回所得獎金及獎狀。",
  },
  {
  ...
  {
    text: "得獎作品隊數及獎項，經「競賽評審委員會議」依參賽隊伍數量差異、各項主題性質不同、主題難易度與作品優異情形議定，必要時可從缺、調整或增加，但以不超過獎金總額為原則。",
  },
  {
    text: "各獎項獎金之領據應由參賽隊伍代表填寫，依所得稅法獎金需扣繳所得稅（獎額含稅），得獎人須攜帶個人身分證正本作為授獎查驗及辦理所得扣繳使用，得獎金額在新臺幣 20,000 元(含)以上，由主辦單位代扣 10%所得稅，並併入該年度綜合所得稅申報納稅，如為非中華民國境內居住之個人(在中華民國境內居留未達 183 天者)，不論金額均需依規定代扣 20%所得稅。",
  },
  {
    text: "得獎作品除公開舉辦頒獎典禮與成果展示外，並將各得獎作品之指導教師與隊員名單與作品簡介等相關資料，整理公布於本競賽網頁提供參考。",
  },
  {
  ...
  {
    text: "凡支領教育部「行動通訊主題式跨層次系統整合教學聯盟計畫」、「下世代行動通訊垂直應用示範基地計畫」人事費之同學，不得報名參加本競賽。",
  },
  { 
    text: "本作業須知如有未盡事宜，得隨時修正之，並公告於競賽網頁。",
  },
  {
    text: "參賽隊伍參加本競賽，皆已閱讀並充分瞭解競賽規定，並且願意完全遵守比賽之各項規定及要求，且了解主辦單位保有變更、調整及取消內容之權利，並同意依中華民國法令辦理之。",
  },
];
